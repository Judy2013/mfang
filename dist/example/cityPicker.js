...
(function ($, win, doc) {
    var CityPicker = (function () {
        function CityPicker(el, options) {
            this.el = $(el);
        ...
        CityPicker.prototype = {
            ...
            createCityPickerBox: function () {
                var proBox = "<div class='picker-box'></div>";
                this.el.append(proBox);
            },
            createProList: function () {
            ...
            createCityList: function (letter, pro) {
            ...
            cityClick: function () {
                ...
                $(".city-picker").on("click", function (e) {
                    ...
                    if ($(target).is("li")) {
                        ...
                        // }
                        if (!!that.options.getCity) {
                            that.options.getCity(that.pro, that.city);
                        }else{
                            console.log(that.pro + "-" + that.city);
                        }
                        // alert(that.pro + "-" + that.city);
